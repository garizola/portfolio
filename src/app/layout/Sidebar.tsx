  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tooltip title="A link to my Github because I am not sure what else to put here :)" arrow placement="right">
          <Link
            target="_blank"
        ...
        {links.map((link) => (
          <Tooltip title={link.title} arrow placement="right" key={link.index}>
            <Link
              ...
              underline="none"
              color="inherit"
              sx={{ WebkitTapHighlightColor: "rgba(0,88,121,1)" }}
            >
              <Box
                sx={{
                  flexGrow: 0,
